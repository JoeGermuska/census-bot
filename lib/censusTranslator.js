...
// Question shapers + articles + prepositions only — never include content words.
...
export const AMBIGUOUS_METRICS = {
  ...
  // Race & ethnicity: default to the non-Hispanic crosstab (B03002), but offer
  // the race-alone variant from B02001 as an alternative chip. Phase B's
  // derivation engine will eventually replace this hand-written mapping.
  asian: [
    {
      id: "B03002_006E",
      ...
      table: "B03002",
      format: "number",
      description: "People who identify racially as Asian alone, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_005E",
      label: "Asian Alone (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "People who identify racially as Asian alone, including those who may also identify as Hispanic or Latino.",
    },
  ],
  black: [
    {
      ...
      table: "B03002",
      format: "number",
      description: "People who identify racially as Black alone, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_003E",
      label: "Black or African American Alone (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "People who identify racially as Black alone, including those who may also identify as Hispanic or Latino.",
    },
  ],
  white: [
    {
      ...
      table: "B03002",
      format: "number",
      description: "People who identify racially as White alone, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_002E",
      label: "White Alone (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "People who identify racially as White alone, including those who may also identify as Hispanic or Latino.",
    },
  ],
  aian: [
    {
      ...
      table: "B03002",
      format: "number",
      description: "American Indian and Alaska Native, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_004E",
      label: "American Indian and Alaska Native Alone (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "American Indian and Alaska Native, including those who may also identify as Hispanic or Latino.",
    },
  ],
  pacific_islander: [
    {
      id: "B03002_007E",
      label: "Native Hawaiian and Other Pacific Islander Alone, Not Hispanic",
      table: "B03002",
      format: "number",
      description: "NHPI, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_006E",
      label: "Native Hawaiian and Other Pacific Islander Alone (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "NHPI, including those who may also identify as Hispanic or Latino.",
    },
  ],
  multiracial: [
    {
      ...
      table: "B03002",
      format: "number",
      description: "People who identify as two or more races, excluding those who also identify as Hispanic or Latino.",
    },
    {
      id: "B02001_008E",
      label: "Two or More Races (Any Ethnicity)",
      table: "B02001",
      format: "number",
      description: "People who identify as two or more races, including those who may also identify as Hispanic or Latino.",
    },
  ],
};
...
export const AMBIGUOUS_KEYWORD_TRIGGERS = {
  ...
  white: ["white"],
  aian: ["native american", "american indian", "aian"],
  pacific_islander: ["pacific islander", "native hawaiian", "nhpi"],
  multiracial: ["two or more races", "multiracial"],
};
