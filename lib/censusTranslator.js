...
export const VARIABLE_MAP = {
  ...
  "poverty rate":         { id: "B17001_002E", label: "Poverty Rate",               format: "number" },
  ...
  "commute time":         { id: "B08303_001E", label: "Mean Travel Time to Work (min)", format: "minutes" },
  "travel time":          { id: "B08303_001E", label: "Mean Travel Time to Work (min)", format: "minutes" },
  "unemployment rate":    { id: "B23025_005E", label: "Unemployment Rate",          format: "number" },
...
export function formatValue(raw, format) {
  ...
  switch (format) {
    ...
    case "years":
      return `${parseFloat(num.toFixed(1))} years`;
    case "minutes":
      return `${parseFloat(num.toFixed(1))} minutes`;
    default:
      return String(num);
  }
}